						...
						<div class="contentArea">
							...
							<div class="btnAndSearch">
								<table class="bas">
									<tr>
										<td id="leftArea">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<button class="mdi mdi-delete-forever takeManyBtn"
												type="button"
							...
							<c:choose>
								<c:when test="${sc eq 1}">
									...
									<ul class="pagingBar">
										<li class="pstyle"><a style="width: 50px;" class="pstyle"
											href="dsearch.mil?condition=${condition}&keyword=${keyword}&currentPage=1">first</a></li>
										<c:choose>
											<c:when test="${ pi.currentPage eq 1 }">
												<li><a class="pstyle disabled" href="#"
													style="width: 70px;">previous</a></li>
											</c:when>
											<c:otherwise>
												<li class="pstyle"><a
													href="dsearch.mil?condition=${condition}&keyword=${keyword}&currentPage=${ pi.currentPage-1 }"
													style="width: 70px;">previous</a></li>
											</c:otherwise>
										</c:choose>
										...
										<c:forEach var="p" begin="${ pi.startPage }"
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="pstyle"><a
														href="dsearch.mil?condition=${condition}&keyword=${keyword}&currentPage=${ p }">${ p }</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										...
										<li class="pstyle"><a
											href="dsearch.mil?condition=${condition}&keyword=${keyword}&currentPage=${ pi.maxPage }"
								...
								<c:otherwise>
									...
									<ul class="pagingBar">
										<li class="pstyle"><a style="width: 50px;" class="pstyle"
											href="dlist.mil?currentPage=1&mailOwn=${loginUser.empNo }">first</a></li>
										<c:choose>
											<c:when test="${ pi.currentPage eq 1 }">
											...
											<c:otherwise>
												<li class="pstyle"><a style="width: 70px;"
													href="dlist.mil?currentPage=${ pi.currentPage-1 }&mailOwn=${loginUser.empNo }">previous</a></li>
											</c:otherwise>
										</c:choose>
										...
										<c:forEach var="p" begin="${ pi.startPage }"
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="pstyle"><a
														href="dlist.mil?currentPage=${ p }&mailOwn=${loginUser.empNo }">${ p }</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										...
										<c:choose>
											...
											<c:otherwise>
												<li class="pstyle"><a style="width: 50px;"
													href="dlist.mil?currentPage=${ pi.currentPage+1 }&mailOwn=${loginUser.empNo }">next</a></li>
											</c:otherwise>
										</c:choose>
										<li class="pstyle"><a style="width: 50px;"
											href="dlist.mil?currentPage=${ pi.maxPage }&mailOwn=${loginUser.empNo }">last</a></li>
									</ul>
									<!-- 페이징바 -->
								</c:otherwise>
							</c:choose>
