						...
						<div class="contentArea">
								...
								<thead>
									<tr>
										...
										<th width="80"><label><input type="checkbox"
												...
												src="resources/images/star-black-48dp.svg"></label></th>
							...
							<c:choose>
								<c:when test="${sc eq 1}">
									...
									<ul class="pagingBar">
										<li class="pstyle"><a style="width: 50px;" class="pstyle"
											href="isearch.mil?condition=${condition}&keyword=${keyword}&currentPage=1">first</a></li>
										<c:choose>
											...
											<c:otherwise>
												<li class="pstyle"><a
													href="isearch.mil?condition=${condition}&keyword=${keyword}&currentPage=${ pi.currentPage-1 }"
													style="width: 80px;">previous</a></li>
											</c:otherwise>
										</c:choose>
										...
										<c:forEach var="p" begin="${ pi.startPage }"
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="pstyle"><a
														href="isearch.mil?condition=${condition}&keyword=${keyword}&currentPage=${ p }">${ p }</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										...
										<li class="pstyle"><a
											href="isearch.mil?condition=${condition}&keyword=${keyword}&currentPage=${ pi.maxPage }"
								...
								<c:otherwise>
									...
									<ul class="pagingBar">
										<li class="pstyle"><a style="width: 50px;" class="pstyle"
											href="ilist.mil?currentPage=1&mailOwn=${loginUser.empNo }">first</a></li>
										<c:choose>
											<c:when test="${ pi.currentPage eq 1 }">
											...
											<c:otherwise>
												<li class="pstyle"><a style="width: 80px;"
													href="ilist.mil?currentPage=${ pi.currentPage-1 }&mailOwn=${loginUser.empNo }">previous</a></li>
											</c:otherwise>
										</c:choose>
										...
										<c:forEach var="p" begin="${ pi.startPage }"
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="pstyle"><a
														href="ilist.mil?currentPage=${ p }&mailOwn=${loginUser.empNo }">${ p }</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										...
										<c:choose>
											...
											<c:otherwise>
												<li class="pstyle"><a style="width: 50px;"
													href="ilist.mil?currentPage=${ pi.currentPage+1 }&mailOwn=${loginUser.empNo }">next</a></li>
											</c:otherwise>
										</c:choose>
										<li class="pstyle"><a style="width: 50px;"
											href="ilist.mil?currentPage=${ pi.maxPage }&mailOwn=${loginUser.empNo }">last</a></li>
									</ul>
									<!-- 페이징바 -->
								</c:otherwise>
							</c:choose>
